...
public class HelpPage {
    ...
    public Node getView() {
        ...
        sourcesList.getChildren().add(createSourceEntry("Tricycle (Vehicle):", AppConstants.EF_TRANSPORT_TRICYCLE_VEHICLE_KGCO2_PER_KM + " kg CO2/km", "CO2 only. Source: Biona et al. (2007)."));
        ...
        sourcesList.getChildren().add(createSourceEntry("Flights - Short Haul (Economy, RFI=3):", AppConstants.EF_TRANSPORT_FLIGHT_SHORT_HAUL_ECONOMY_RFI3_KGCO2E_PER_PKM + " kg CO2e/pkm", "Global average, RFI=3. Source: Derived based on myclimate.org concepts."));
        sourcesList.getChildren().add(createSourceEntry("Flights - Long Haul (Economy, RFI=3):", AppConstants.EF_TRANSPORT_FLIGHT_LONG_HAUL_ECONOMY_RFI3_KGCO2E_PER_PKM + " kg CO2e/pkm", "Global average, RFI=3. Source: Derived based on myclimate.org concepts."));


        // TODO: Add source entries for Waste and Goods categories.
